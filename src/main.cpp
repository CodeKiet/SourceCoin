...
static const int64 SubsidyHalvingInterval = 840960;
unsigned int nStakeMinAge = 60 * 60 * 24 * 15;	// minimum age for coin age: 15
unsigned int nStakeMaxAge = 60 * 60 * 24 * 30;	// stake age of full weight: 30d
unsigned int nStakeTargetSpacing = 150;			// 2.5 Mins block spacing

int64 nChainStartTime = 1397411086;
...
const string strMessageMagic = "SourceCoin Signed Message:\n";
...
const int YEARLY_BLOCKCOUNT = 201240;	// 365 * 2880
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in SourceCoin
    bool fStrictPayToScriptHash = true; // Always active in SourceCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "SourceCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Source Coin";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = 1397411086;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1272378;
        ...
        assert(block.hashMerkleRoot == uint256("0x471ce0d1a1a3245c727d8fa14b2b85acf5223b05ab0961b6a00c495eb40e8800"));
